...
public class X_FTU_LoadOrderLineMA extends PO implements I_FTU_LoadOrderLineMA, I_Persistent 
{
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FTU_LoadOrderLineMA[")
    ...
    {
		return (net.frontuari.recordweight.model.I_FTU_LoadOrderLine)MTable.get(getCtx(), net.frontuari.recordweight.model.I_FTU_LoadOrderLine.Table_Name)
