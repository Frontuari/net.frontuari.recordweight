...
@Process
public class CreateServiceOrderFromShipperLiq extends FTUProcess {
	...
	protected String doIt() throws Exception {
		...
		MFTUShipperLiquidation fc = new MFTUShipperLiquidation(getCtx(), getRecord_ID(), get_TrxName());
		if(fc.get_ID()<=0)
		...
		o.setDateOrdered(p_DateDoc);
		o.setDateAcct(p_DateDoc);
		...
		MInOut io = new MInOut(o, o.getC_DocType().getC_DocTypeShipment_ID(), p_DateDoc);
		io.saveEx();
