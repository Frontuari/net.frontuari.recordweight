...
public abstract class FTUEventFactory extends AbstractEventHandler implements IEventTopics {
	...
	private void execEventHandler(Event event, EventHandlerWrapper eventHandlerWrapper, PO po) {
		FTUModelEvents customEventHandler;
		try {
	 ...
	 */
	protected void registerEvent(String eventTopic, String tableName, Class<? extends FTUModelEvents> eventHandler) {
	 ...
	 * @param eventHandler Event listeners
	 */
	protected void registerEvent(String eventTopic, Class<? extends FTUModelEvents> eventHandler) {
	...
	class EventHandlerWrapper {
		...
		private Class<? extends FTUModelEvents> eventHandler;

		public EventHandlerWrapper(String eventType, String tableName, Class<? extends FTUModelEvents> eventHandlerClass) {
		...
		public Class<? extends FTUModelEvents> getEventHandler() {
			return eventHandler;
		}
