...
import static net.frontuari.recordweight.test.util.RandomTestUtil.*;
import static net.frontuari.recordweight.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"net.frontuari.recordweight.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"net.frontuari.recordweight.util\"");
	}
